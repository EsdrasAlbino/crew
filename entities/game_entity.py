...
class Game(object):
    ...
    def run(self, screen, __, event):
        ...
        for _throttle in self.throttle_group.sprites():
            ...
            _throttle.posicion = (propellant_new_coords[0],propellant_new_coords[1])
